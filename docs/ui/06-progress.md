...
| **M4 功能对齐** | ✅ 完成 | 8 页全部实现(D/R/O/C/U/S/T/H) |
| **M5 可分发** | ✅ 完成 | macOS dmg 实测 4.4MB;三端 CI 配置就绪 |
...
| **T 转码&改名** | ✅ | opus→mp3(ffmpeg)、随机播放改名(加/去前缀) |
| **H 帮助中心** | ✅ | 快速上手/分类体系/FAQ/排错/已知限制 |
...
- **代码签名**:macOS 未签名,用户首次需右键打开;Windows 未签名会 SmartScreen 警告
- **yt-dlp/ffmpeg 未内置**:体积考虑,首启环境自检引导下载
